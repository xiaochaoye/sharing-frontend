<template>
  <div class="wscn-http404-container">
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        <div class="bullshit__oops">OH,不!</div>
        <div class="bullshit__info">你好像走错了</div>
        <div class="bullshit__headline">{{ message }}</div>
        <div class="bullshit__info">在我写出这个页面之前，请你检查你的网页路径是否正确</div>
        <el-button type="primary" round @click="backToHome">带你回去</el-button>
      </div>
    </div>
  </div>
</template>
...
const message = '世上本没有路，走的人多了，也就成了路。'
const backToHome = () => {
  router.push('/')
}
